 ...
 */
 ...
 !(async () => {
     ...
     for (let index = 0; index < ckArr.length; index++) {
         ...
         zmd_headers = {
            ...
            'Cookie': ck,
            //'cookie': 'sess=BA-gP61uLB8Xkj%2FpfeFX9RhOxpxuWwVNqnoSa7p5E%2BWK4Q3UiHFc3qhtdx1dyRGy4WPRM%2FwpmbsnQMhBLOyuOh4K6W46stNEAVvMwDCTknpFFkV8zs5i64GHZ9C'
         }
         await start();
     }
     await SendMsg(msg);
 ...
 async function user_info() {
     ...
     if (result.error_code == 0) {
         console.log(`\n   值得买签到:今日签到${result.error_msg}, 累计签到${result.data.continue_checkin_days} 天,其他 ${result.data.slogan}   💪🏻 `);
         msg += `\n   值得买签到:今日签到${result.error_msg}, 累计签到${result.data.continue_checkin_days} 天,其他 ${result.data.slogan}    💪🏻 `;
