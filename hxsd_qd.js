 ...
 */
 ...
 async function user_info() {
     ...
     let result = await httpGet(url, `火星时代签到`);
 
     if (result.code == 0) {
         console.log(`\n   火星时代签到:今日签到${result.message}, 累计签到${result.data} 天,童鞋还要加强教育啊   💪🏻 `);
         msg += `\n   火星时代签到:今日签到${result.message}, 累计签到${result.data} 天,童鞋还要加强教育啊   💪🏻 `;
    } else if (result.code == "200") {
        console.log(`\n   火星时代签到: ${result.data} `);
        msg += `\n   火星时代签到: ${result.data}`;
     } else {
         console.log(`\n   火星时代签到: 失败 ❌ 了呢,原因未知！  ${result} `);
         msg += `\n    火星时代签到: 失败 ❌ 了呢,原因未知!`;
     }
 }
